                    ...
                    <div class="row">
                        ...
                        <div class=" col-lg-7 col-md-7 col-sm-7 col-xs-12 pull-left">
                            ...
                            <div class="work_bottom"> <span>Want to know more..</span>
                                ...
                                {{--<a href="#contact" class="contact_btn"></a> </div>--}}
                        </div>
                ...
                @endif
                        <div class="col-lg-4
                            ...
                            <div class="service_block">
                                <div class="service_icon delay-03s animated wow  zoomIn"> <span><i class="fa {{ $item->icon }}"></i></span> </div>
                                <h3 class="animated fadeInUp wow">{{ $item->name }}</h3>
                                <p class="animated fadeInDown wow">{{ $item->text }}</p>
                            </div>
                        </div>
                        @if(($k +1)%3 == 0)
                    </div>
            ...
            @foreach($portfolio as $item)
                <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;"
                    ...
                    <div class="portfolio_img">
                        {!! Html::image('assets/img/' . $item->images, 'Portfolio 1') !!}
                    </div>
    ...
    <div class="client_logos"><!--client_logos-->
        <div class="container">
            <ul class="fadeInRight animated wow">
                <li><a href="javascript:void(0)">{!! Html::image('assets/img/client_logo1.png', 'logo1') !!}</a></li>
                <li><a href="javascript:void(0)">{!! Html::image('assets/img/client_logo2.png', 'logo2') !!}</a></li>
                <li><a href="javascript:void(0)">{!! Html::image('assets/img/client_logo3.png', 'logo3') !!}</a></li>
                <li><a href="javascript:void(0)">{!! Html::image('assets/img/client_logo4.png', 'logo4') !!}</a></li>
            </ul>
        </div>
    </div>
</section>
        ...
        <div class="team_section clearfix">
            ...
            <div class="team_area">
                <div class="team_box wow fadeInDown delay-0{{ $k*3 + 3 }}s">
                    ...
                    {!! Html::image('assets/img/' . $man->images, 'pic1') !!}
                    <ul>
                ...
                <h3 class="wow fadeInDown delay-0{{ $k*3 + 3 }}s">{{ $man->name }}</h3>
                <span class="wow fadeInDown delay-0{{ $k*3 + 3 }}s">{{ $man->profession }}</span>
                <p class="wow fadeInDown delay-0{{ $k*3 + 3 }}s">{{ $man->text }}</p>
            </div>
            @endforeach
        </div>
    </div>
...
<footer class="footer_wrapper" id="contact">
    ...
    <div class="container">
        <div class="footer_bottom"><span>Copyright © 2016</span> </div>
    </div>
</footer>